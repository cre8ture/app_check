...
const CancelButton = ({ onClick }) => {
  return (
    <button
      ...
      onClick={onClick}
    >
      <svg className="text-gray-500" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="1em" height="1em">
